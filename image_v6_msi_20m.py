...
salvar_banda(kd_msi_b1, r'.\03_Results_image\QAAv6_msi_2019_20m_443nm.tif', dataset_de_referencia)
del kd_msi_b1
gc.collect()

kd_msi_b2 = Qaa_v6_model_msi(b2, 492, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b2, r'.\03_Results_image\QAAv6_msi_2019_20m_492nm.tif', dataset_de_referencia)
del kd_msi_b2
gc.collect()

kd_msi_b3 = Qaa_v6_model_msi(b3, 560, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b3, r'.\03_Results_image\QAAv6_msi_2019_20m_560nm.tif', dataset_de_referencia)
del kd_msi_b3
gc.collect()

kd_msi_b4 = Qaa_v6_model_msi(b4, 665, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b4, r'.\03_Results_image\QAAv6_msi_2019_20m_665nm.tif', dataset_de_referencia)
del kd_msi_b4
gc.collect()

kd_msi_b5 = Qaa_v6_model_msi(b5, 704, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b5, r'.\03_Results_image\QAAv6_msi_2019_20m_704nm.tif', dataset_de_referencia)
del kd_msi_b5
gc.collect()
...
kd_pred_443 = kd_pred['Kd_QAAv6_20m_443']        ##  Dados simulados (y_pred)
...
eq_443 = 'y = 0,8698x + 0,1433'
stat_443 = 'R² = 0,4590, MAPE = 11,60%; RMSE = 0,1123 m^-1; n = 20'
...
kd_pred_492 = kd_pred['Kd_QAAv6_20m_492']
...
eq_492 = 'y = 0,9504x + 0,2071'
stat_492 = 'R² = 0,5078, MAPE = 31,05%; RMSE = 0,1944 m^-1; n = 20'
...
kd_pred_560 = kd_pred['Kd_QAAv6_20m_560']
...
eq_560 = 'y = 0,6230x + 0,3899'
stat_560 = 'R² = 0,1951, MAPE = 68,20%; RMSE = 0,2564 m^-1; n = 20'
...
kd_pred_665 = kd_pred['Kd_QAAv6_20m_665']
...
eq_665 = 'y = 0,0279x + 1,0208'
stat_665 = 'R² = 6,77E-5; MAPE = 57,13%; RMSE = 0,3899 m^-1; n = 20'
...
kd_pred_704 = kd_pred['Kd_QAAv6_20m_704']
...
eq_704 = 'y = 0,3050x + 0,9462'
stat_704 = 'R² = 0,1472; MAPE = 45,01%; RMSE = 0,3735 m^-1; n = 20'
...
plt.text(0.6, 0.45, eq_443, fontsize = 10)
plt.text(0.6, 0.25, 'R² = 0,4590; MAPE = 11,60%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,1123 m^-1; n = 20', fontsize = 10)
plt.plot(ref_443, 'r--')
...
plt.text(0.6, 0.25, 'R² = 0,5078; MAPE = 31,05%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,1944 m^-1; n = 20', fontsize = 10)
plt.plot(ref_492, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
plt.text(0.6, 0.25, 'R² = 0,1951; MAPE = 68,20%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,2564 m^-1; n = 20', fontsize = 10)
plt.plot(ref_560, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
plt.text(0.6, 0.25, 'R² = 6,77E-5; MAPE = 57,13%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,3899 m^-1; n = 20', fontsize = 10)
plt.plot(ref_665, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
##  Texto para plotagem com dados dos resultados estatísticos e da regressão
eq_global = 'y = 0,8736x + 0,3246'
stat_global = 'R² = 0,5474; MAPE = 42,60 %; RMSE = 0,2855 m^-1; n = 100'
...
plt.text(0.6, 0.2, 'R² = 0,5474; MAPE = 42,60%', fontsize = 10)
plt.text(0.6, 0.1, 'RMSE = 0,2855 m^-1; n = 100', fontsize = 10)
