...
salvar_banda(kd_msi_b1, r'.\03_Results_image\QAAv6_msi_2019_60m_443nm.tif', dataset_de_referencia)
del kd_msi_b1
gc.collect()

kd_msi_b2 = Qaa_v6_model_msi(b2, 492, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b2, r'.\03_Results_image\QAAv6_msi_2019_60m_492nm.tif', dataset_de_referencia)
del kd_msi_b2
gc.collect()

kd_msi_b3 = Qaa_v6_model_msi(b3, 560, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b3, r'.\03_Results_image\QAAv6_msi_2019_60m_560nm.tif', dataset_de_referencia)
del kd_msi_b3
gc.collect()

kd_msi_b4 = Qaa_v6_model_msi(b4, 665, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b4, r'.\03_Results_image\QAAv6_msi_2019_60m_665nm.tif', dataset_de_referencia)
del kd_msi_b4
gc.collect()

kd_msi_b5 = Qaa_v6_model_msi(b5, 704, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b5, r'.\03_Results_image\QAAv6_msi_2019_60m_704nm.tif', dataset_de_referencia)
del kd_msi_b5
gc.collect()
...
kd_pred_443 = kd_pred['Kd_QAAv6_60m_443']        ##  Dados simulados (y_pred)
...
eq_443 = 'y = 0,8299x + 0,1853'
stat_443 = 'R² = 0,5204, MAPE = 10,07%; RMSE = 0,1001 m^-1; n = 20'
...
kd_pred_492 = kd_pred['Kd_QAAv6_60m_492']
...
eq_492 = 'y = 0,8568x + 0,2764'
stat_492 = 'R² = 0,4895, MAPE = 33,72%; RMSE = 0,2062 m^-1; n = 20'
...
kd_pred_560 = kd_pred['Kd_QAAv6_60m_560']
...
eq_560 = 'y = 0,5184x + 0,4436'
stat_560 = 'R² = 0,1340, MAPE = 72,31%; RMSE = 0,2715 m^-1; n = 20'
...
kd_pred_665 = kd_pred['Kd_QAAv6_60m_665']
...
eq_665 = 'y = 0,1420x + 0,9668'
stat_665 = 'R² = 0,0019; MAPE = 60,36%; RMSE = 0,4094 m^-1; n = 20'
...
kd_pred_704 = kd_pred['Kd_QAAv6_60m_704']
...
eq_704 = 'y = 0,3341x + 0,9344'
stat_704 = 'R² = 0,1784; MAPE = 46,49%; RMSE = 0,3855 m^-1; n = 20'
...
plt.text(0.6, 0.25, 'R² = 0,5204; MAPE = 10,07%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,1001 m^-1; n = 20', fontsize = 10)
plt.plot(ref_443, 'r--')
...
plt.text(0.6, 0.25, 'R² = 0,4895; MAPE = 33,72%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,2062 m^-1; n = 20', fontsize = 10)
plt.plot(ref_492, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
plt.text(0.6, 0.25, 'R² = 0,1340; MAPE = 72,31%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,2715 m^-1; n = 20', fontsize = 10)
plt.plot(ref_560, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
plt.text(0.6, 0.25, 'R² = 0,0019; MAPE = 60,36%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,4094 m^-1; n = 20', fontsize = 10)
plt.plot(ref_665, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
##  Texto para plotagem com dados dos resultados estatísticos e da regressão
eq_global = 'y = 0,8574x + 0,3495'
stat_global = 'R² = 0,5399; MAPE = 44,59 %; RMSE = 0,2975 m^-1; n = 100'
...
plt.text(0.6, 0.2, 'R² = 0,5399; MAPE = 44,59%', fontsize = 10)
plt.text(0.6, 0.1, 'RMSE = 0,2975 m^-1; n = 100', fontsize = 10)
