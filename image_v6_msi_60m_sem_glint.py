...
##  Reamostragem espacial das bandas B1 (60m / 3) e B2 a B4 (10 m * 2): [RE = 20 metros];
##  mode = ['reflect', 'constant', 'nearest', 'mirror', 'wrap'];
b2 = scipy.ndimage.zoom(b2, 0.16666666666666, order = 0, mode = 'nearest')
b3 = scipy.ndimage.zoom(b3, 0.16666666666666, order = 0, mode = 'nearest')
b4 = scipy.ndimage.zoom(b4, 0.16666666666666, order = 0, mode = 'nearest')
b5 = scipy.ndimage.zoom(b5, 0.33333333333333, order = 0, mode = 'nearest')
b11 = scipy.ndimage.zoom(b11, 0.33333333333333, order = 0, mode = 'nearest')
...
salvar_banda(kd_msi_b1, r'.\03_Results_image\QAAv6_msi_2019_60m_sem_glint_443nm.tif', dataset_de_referencia)
del kd_msi_b1
gc.collect()

kd_msi_b2 = Qaa_v6_model_msi(b2, 492, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b2, r'.\03_Results_image\QAAv6_msi_2019_60m_sem_glint_492nm.tif', dataset_de_referencia)
del kd_msi_b2
gc.collect()

kd_msi_b3 = Qaa_v6_model_msi(b3, 560, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b3, r'.\03_Results_image\QAAv6_msi_2019_60m_sem_glint_560nm.tif', dataset_de_referencia)
del kd_msi_b3
gc.collect()

kd_msi_b4 = Qaa_v6_model_msi(b4, 665, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b4, r'.\03_Results_image\QAAv6_msi_2019_60m_sem_glint_665nm.tif', dataset_de_referencia)
del kd_msi_b4
gc.collect()

kd_msi_b5 = Qaa_v6_model_msi(b5, 704, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b5, r'.\03_Results_image\QAAv6_msi_2019_60m_sem_glint_704nm.tif', dataset_de_referencia)
del kd_msi_b5
gc.collect()
...
kd_pred_443 = kd_pred['Kd_QAAv6_60m_s-glint_443']        ##  Dados simulados (y_pred)
...
eq_443 = 'y = 0,9974x - 0,0766'
stat_443 = 'R² = 0,5288, MAPE = 12,24%; RMSE = 0,1324 m^-1; n = 20'
...
kd_pred_492 = kd_pred['Kd_QAAv6_60m_s-glint_492']
...
eq_492 = 'y = 1,0672x + 0,0310'
stat_492 = 'R² = 0,6400, MAPE = 14,23%; RMSE = 0,0973 m^-1; n = 20'
...
kd_pred_560 = kd_pred['Kd_QAAv6_60m_s-glint_560']
...
eq_560 = 'y = 0,8510x + 0,1990'
stat_560 = 'R² = 0,3774, MAPE = 39,10%; RMSE = 0,1522 m^-1; n = 20'
...
kd_pred_665 = kd_pred['Kd_QAAv6_60m_s-glint_665']
...
eq_665 = 'y = 0,1193x + 0,8668'
stat_665 = 'R² = 0,0013; MAPE = 42,98%; RMSE = 0,2997 m^-1; n = 20'
...
kd_pred_704 = kd_pred['Kd_QAAv6_60m_s-glint_704']
...
eq_704 = 'y = 0,3520x + 0,8339'
stat_704 = 'R² = 0,2158; MAPE = 36,11%; RMSE = 0,3004 m^-1; n = 20'
...
plt.text(0.6, 0.25, 'R² = 0,5288; MAPE = 12,24', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,1324 m^-1; n = 20', fontsize = 10)
plt.plot(ref_443, 'r--')
...
plt.subplot(222)
plt.text(0.5, 1.25, 'b)', fontsize = 12)
plt.text(0.6, 0.41, eq_492, fontsize = 10)
plt.text(0.6, 0.25, 'R² = 0,6400; MAPE = 14,23%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,0973 m^-1; n = 20', fontsize = 10)
plt.plot(ref_492, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
plt.text(0.6, 0.45, eq_560, fontsize = 10)
plt.text(0.6, 0.25, 'R² = 0,3774; MAPE = 39,10%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,1522 m^-1; n = 20', fontsize = 10)
plt.plot(ref_560, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
plt.text(0.6, 0.45, eq_665, fontsize = 10)
plt.text(0.6, 0.25, 'R² = 0,0013; MAPE = 42,98%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,2997 m^-1; n = 20', fontsize = 10)
plt.plot(ref_665, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
##  Texto para plotagem com dados dos resultados estatísticos e da regressão
eq_global = 'y = 0,9168x + 0,1980'
stat_global = 'R² = 0,5457; MAPE = 28,93 %; RMSE = 0,2146 m^-1; n = 100'
...
plt.text(0.6, 0.2, 'R² = 0,5457; MAPE = 28,93%', fontsize = 10)
plt.text(0.6, 0.1, 'RMSE = 0,2146 m^-1; n = 100', fontsize = 10)
...
plt.xlabel('Kd ZEU (GLOBAL)', fontsize = 14)
