...
b1 = scipy.ndimage.zoom(b1, 3, order = 0, mode = 'nearest')
b2 = scipy.ndimage.zoom(b2, 0.5, order = 0, mode = 'nearest')
b3 = scipy.ndimage.zoom(b3, 0.5, order = 0, mode = 'nearest')
b4 = scipy.ndimage.zoom(b4, 0.5, order = 0, mode = 'nearest')
...
##  
ref_band = r'.\00_Dados\Imagens\utm_mask_T23KMV_20190701T131251_B05.tif'
...
salvar_banda(kd_msi_b1, r'.\03_Results_image\QAAv6_msi_2019_20m_sem_glint_443nm.tif', dataset_de_referencia)
del kd_msi_b1
gc.collect()

kd_msi_b2 = Qaa_v6_model_msi(b2, 492, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b2, r'.\03_Results_image\QAAv6_msi_2019_20m_sem_glint_492nm.tif', dataset_de_referencia)
del kd_msi_b2
gc.collect()

kd_msi_b3 = Qaa_v6_model_msi(b3, 560, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b3, r'.\03_Results_image\QAAv6_msi_2019_20m_sem_glint_560nm.tif', dataset_de_referencia)
del kd_msi_b3
gc.collect()

kd_msi_b4 = Qaa_v6_model_msi(b4, 665, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b4, r'.\03_Results_image\QAAv6_msi_2019_20m_sem_glint_665nm.tif', dataset_de_referencia)
del kd_msi_b4
gc.collect()

kd_msi_b5 = Qaa_v6_model_msi(b5, 704, b1, b2, b3, b4, b5, 560, aw, bbw, theta_s)
salvar_banda(kd_msi_b5, r'.\03_Results_image\QAAv6_msi_2019_20m_sem_glint_704nm.tif', dataset_de_referencia)
del kd_msi_b5
gc.collect()
...
kd_pred_443 = kd_pred['Kd_QAAv6_20m_s-glint_443']        ##  Dados simulados (y_pred)
...
eq_443 = 'y = 1,0273x - 0,1034'
stat_443 = 'R² = 0,4741, MAPE = 14,63%; RMSE = 0,1462 m^-1; n = 20'
...
kd_pred_492 = kd_pred['Kd_QAAv6_20m_s-glint_492']
...
eq_492 = 'y = 1,1208x - 0,0099'
stat_492 = 'R² = 0,6391, MAPE = 13,11%; RMSE = 0,0937 m^-1; n = 20'
...
kd_pred_560 = kd_pred['Kd_QAAv6_20m_s-glint_560']
...
eq_560 = 'y = 0,8404x + 0,1919'
stat_560 = 'R² = 0,4661, MAPE = 36,18%; RMSE = 0,1389 m^-1; n = 20'
...
kd_pred_665 = kd_pred['Kd_QAAv6_20m_s-glint_665']
...
eq_665 = 'y = -0,4639x + 1,2306'
stat_665 = 'R² = 0,0200; MAPE = 40,01%; RMSE = 0,2812 m^-1; n = 20'
...
kd_pred_704 = kd_pred['Kd_QAAv6_20m_s-glint_704']
...
eq_704 = 'y = 0,2067x + 0,9429'
stat_704 = 'R² = 0,0937; MAPE = 34,78%; RMSE = 0,2899 m^-1; n = 20'
...
plt.text(0.6, 0.25, 'R² = 0,4741; MAPE = 14,63%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,1462 m^-1; n = 20', fontsize = 10)
plt.plot(ref_443, 'r--')
...
plt.text(0.6, 0.25, 'R² = 0,6391; MAPE = 13,11%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,0937 m^-1; n = 20', fontsize = 10)
plt.plot(ref_492, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
plt.text(0.6, 0.25, 'R² = 0,4661; MAPE = 36,18%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,1389 m^-1; n = 20', fontsize = 10)
plt.plot(ref_560, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
plt.subplot(224)
plt.text(0.1, 1.25, 'd)', fontsize = 12)
plt.text(0.6, 0.45, eq_665, fontsize = 10)
plt.text(0.6, 0.25, 'R² = 0,0200; MAPE = 40,01%', fontsize = 10)
plt.text(0.6, 0.05, 'RMSE = 0,2812 m^-1; n = 20', fontsize = 10)
plt.plot(ref_665, 'r--')
plt.plot(x, x, color = 'k', ls = '--')
...
##  Texto para plotagem com dados dos resultados estatísticos e da regressão
eq_global = 'y = 0,9253x + 0,1816'
stat_global = 'R² = 0,5556; MAPE = 27,74 %; RMSE = 0,2062 m^-1; n = 100'
...
plt.text(0.6, 0.2, 'R² = 0,5556; MAPE = 27,74%', fontsize = 10)
plt.text(0.6, 0.1, 'RMSE = 0,2062 m^-1; n = 100', fontsize = 10)
